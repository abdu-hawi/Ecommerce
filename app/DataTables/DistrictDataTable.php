...
class DistrictDataTable extends DataTable
{
    ...
    {
        return District::query()->with('country_id')->with('city_id')->select('Districts.*');
    }
            ...
            */
            ->buttons(
                Button::make('create')
                    ...
                    ->text('<i class="fas fa-plus fa-sm"></i> '.trans("admin.create_new_district")),
                Button::make('export')
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('district_name_ar')->name('district_name_ar')->title(trans('admin.district_name_ar')),
            Column::make('district_name_en')->name('district_name_en')->title(trans('admin.district_name_en')),
