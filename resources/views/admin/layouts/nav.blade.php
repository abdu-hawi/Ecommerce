...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="{!! aurl('lang/en') !!}" class="dropdown-item">English</a>
                <a href="{!! aurl('lang/ar') !!}" class="dropdown-item">عربي</a>
            </div>
        </li>
        ...
        <!-- Log out -->
        <li class="nav-item">
            <a class="nav-link" href="{!! url('admin/logout') !!}" alt=" {!! trans('admin.logout') !!}">
