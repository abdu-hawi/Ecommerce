                    ...
                    <div class="card">
                        ...
                        <div class="card-body register-card-body col-12" style="margin-left: auto;margin-right: auto;">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('manufacturer_name_ar',old('manufacturer_name_ar'),['class'=>'form-control']) !!}
                            </div>

                            <div class="form-group">
                                {!! Form::label('manufacturer_name_en',trans('admin.manufacturer_name_en')) !!}
                                {!! Form::text('manufacturer_name_en',old('manufacturer_name_en'),['class'=>'form-control']) !!}
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @if(!empty(old('manufacturer_logo')))
                                    <img src="{!! Storage::url(old('manufacturer_logo')) !!}" height="50"/>
                                @endif
                            </div>
