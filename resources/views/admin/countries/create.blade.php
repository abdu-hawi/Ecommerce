                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li><a href="{!! aurl('countries') !!}">{!! trans('admin.countries') !!}</a> /</li>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body register-card-body col-6" style="margin-left: auto;margin-right: auto;">
                            ...
                            <div class="form-group">
                                {!! Form::label('flag',trans('admin.flag')) !!}
                                {!! Form::file('flag',['class'=>'form-control']) !!}
                                @if(!empty(old('flag')))
                                    <img src="{!! Storage::url(old('flag')) !!}" height="50"/>
                                @endif
                            </div>

                            <div class="form-group">
                                {!! Form::label('ext',trans('admin.ext')) !!}
                                {!! Form::number('ext',old('ext'),['class'=>'form-control']) !!}
                            </div>
