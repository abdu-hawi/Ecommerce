                        ...
                        <div class="card-body register-card-body col-6" style="margin-left: auto;margin-right: auto;">
                            {!! Form::open(['url'=>aurl('users/'.$users->id),'method'=>'put']) !!}
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="name" value="{!! $users->name !!}" placeholder="{!! trans('admin.user_name') !!}">
                                ...
                                <div class="input-group mb-3">
                                    <input type="email" class="form-control" name="email" value="{!! $users->email !!}" placeholder="{!! trans('admin.email') !!}">
                                    <div class="input-group-append">
                                        <div class="input-group-text">
