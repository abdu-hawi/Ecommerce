                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li><a href="{!! aurl('trademarks') !!}">{!! trans('admin.trademarks') !!}</a> /</li>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body register-card-body col-6" style="margin-left: auto;margin-right: auto;">
                            ...
                            <div class="form-group">
                                {!! Form::label('trademark_logo',trans('admin.trademark_logo')) !!}
                                {!! Form::file('trademark_logo',['class'=>'form-control']) !!}
                                @if(!empty(old('trademark_logo')))
                                    <img src="{!! Storage::url(old('trademark_logo')) !!}" height="50"/>
                                @endif
                            </div>
