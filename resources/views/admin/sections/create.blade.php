                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body register-card-body col-6" style="margin-left: auto;margin-right: auto;">
                            {!! Form::open(['url'=>aurl('sections'),'files'=>true]) !!}

                            <div class="form-group">
                                {!! Form::label('section_name_ar',trans('admin.section_name_ar')) !!}
                                {!! Form::text('section_name_ar',old('section_name_ar'),['class'=>'form-control']) !!}
                            </div>

                            <div class="form-group">
                                {!! Form::label('section_name_en',trans('admin.section_name_en')) !!}
                                {!! Form::text('section_name_en',old('section_name_en'),['class'=>'form-control']) !!}
                            </div>

                            <input type="hidden" name="parent" value="{!! old('parent') !!}" class="parent-id">
                            ...
                            <div class="form-group">
                                ...
                                @if(!empty(old('icon_section')))
                                    <img src="{!! Storage::url(old('icon_section')) !!}" height="50"/>
                                @endif
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::textarea('keyword',old('keyword'),['class'=>'form-control', 'rows' => 2]) !!}
                            </div>
